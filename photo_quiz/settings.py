"""
Django settings for photo_quiz project.
...
SECRET_KEY = 'django-insecure-3#-ekrugf2-sc0w)_+#l2%le9x@#n8@ne53*cf5dqbbv_6lh)k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    '127.0.0.1', 'localhost', '192.168.1.34'
]
...
WSGI_APPLICATION = 'photo_quiz.wsgi.application'
